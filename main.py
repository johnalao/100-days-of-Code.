...
if direction_case == "left":
	...
	if boat_case == "wait":
		...
		if door_case == "yellow":
			...
			print("Sorry you have opened the door for a tiger. Game Over")
	else:
		print("Unfortunately, the tide of the water if too much. Game over")
else:
	print("You have opened the door to fire. Game over")
